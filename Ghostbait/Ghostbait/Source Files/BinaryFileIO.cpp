...
template void Writer::Write<int>(std::ofstream & stream, int val);
template void Writer::Write<std::size_t>(std::ofstream & stream, std::size_t val);
template void Writer::Write<double>(std::ofstream & stream, double val);
template void Writer::Write<float>(std::ofstream & stream, float val);
template void Writer::Write<char>(std::ofstream & stream, char val);
template void Writer::Write<DirectX::XMFLOAT4X4>(std::ofstream & stream, DirectX::XMFLOAT4X4 val);

template void Writer::Write<int>(int val);
template void Writer::Write<std::size_t>(std::size_t val);
template void Writer::Write<double>(double val);
template void Writer::Write<float>(float val);
template void Writer::Write<char>(char val);
template void Writer::Write<DirectX::XMFLOAT4X4>(DirectX::XMFLOAT4X4 val);

template int Reader::Read<int>(std::ifstream & stream);
template std::size_t Reader::Read<std::size_t>(std::ifstream & stream);
template double Reader::Read<double>(std::ifstream & stream);
template float Reader::Read<float>(std::ifstream & stream);
template char Reader::Read<char>(std::ifstream & stream);
template DirectX::XMFLOAT4X4 Reader::Read<DirectX::XMFLOAT4X4>(std::ifstream & stream);

template int Reader::Read<int>();
template std::size_t Reader::Read<std::size_t>();
template double Reader::Read<double>();
template float Reader::Read<float>();
template char Reader::Read<char>();
template DirectX::XMFLOAT4X4 Reader::Read<DirectX::XMFLOAT4X4>();
