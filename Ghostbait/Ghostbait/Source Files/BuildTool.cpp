...
void BuildTool::RemoveProjection() {
	...
	Raycast(DirectX::XMFLOAT3(position._41, position._42, position._43), DirectX::XMFLOAT3(position._31, position._32, position._33), &endPos, &currentlySelectedItem, 4);
