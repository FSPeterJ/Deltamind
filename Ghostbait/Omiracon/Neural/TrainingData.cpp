...
template class TrainingDataWriter<int, int>;
template class TrainingDataReader<int, int>;
template class TrainingDataWriter<double, double>;
template class TrainingDataReader<double, double>;
